...
#
# Usage:
#   mvn_update_security.sh [OPTIONS]
#
# Options:
...
#   ./mvn_update_security.sh --update
#
#   # Verify baselines are current
#   ./mvn_update_security.sh --verify
#
#   # Update for specific project
#   ./mvn_update_security.sh --project-root /path/to/project --update
#
#   # Use properties format instead of CSV
#   ./mvn_update_security.sh --checksum-format properties --update
...
show_help() {
    cat << 'EOF'
mvn_update_security.sh - Update Maven dependency security baselines
...
EXAMPLES:
    # Update baselines for current project
    ./mvn_update_security.sh -u

    # Verify baselines are current
    ./mvn_update_security.sh -v
...

{
    ...
    echo "# Generated by scripts/security/mvn_update_security.sh"
