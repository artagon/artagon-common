...
#
# Usage:
#   mvn-update-dep-security.sh [OPTIONS]
#
# Options:
...
#   ./mvn-update-dep-security.sh --update
#
#   # Verify baselines are current
#   ./mvn-update-dep-security.sh --verify
#
#   # Update for specific project
#   ./mvn-update-dep-security.sh --project-root /path/to/project --update
#
#   # Use properties format instead of CSV
#   ./mvn-update-dep-security.sh --checksum-format properties --update
...
show_help() {
    cat << 'EOF'
mvn-update-dep-security.sh - Update Maven dependency security baselines
...
EXAMPLES:
    # Update baselines for current project
    ./mvn-update-dep-security.sh -u

    # Verify baselines are current
    ./mvn-update-dep-security.sh -v
...
if ! require_commands curl gpg openssl "${MVN_CMD}"; then
...

{
    ...
    echo "# Generated by scripts/security/mvn-update-dep-security.sh"
